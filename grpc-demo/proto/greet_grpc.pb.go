...
type GreetServiceClient interface {
	...
	SatHelloServerSideStreaming(ctx context.Context, in *NamesList, opts ...grpc.CallOption) (GreetService_SatHelloServerSideStreamingClient, error)
...
func (c *greetServiceClient) SatHelloServerSideStreaming(ctx context.Context, in *NamesList, opts ...grpc.CallOption) (GreetService_SatHelloServerSideStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greet_service.GreetService/SatHelloServerSideStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSatHelloServerSideStreamingClient{stream}
...
type GreetService_SatHelloServerSideStreamingClient interface {
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSatHelloServerSideStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSatHelloServerSideStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
...
type GreetServiceServer interface {
	...
	SatHelloServerSideStreaming(*NamesList, GreetService_SatHelloServerSideStreamingServer) error
...
func (UnimplementedGreetServiceServer) SatHelloServerSideStreaming(*NamesList, GreetService_SatHelloServerSideStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SatHelloServerSideStreaming not implemented")
}
...
func _GreetService_SatHelloServerSideStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(NamesList)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GreetServiceServer).SatHelloServerSideStreaming(m, &greetServiceSatHelloServerSideStreamingServer{stream})
}

type GreetService_SatHelloServerSideStreamingServer interface {
	Send(*HelloResponse) error
	grpc.ServerStream
}

type greetServiceSatHelloServerSideStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSatHelloServerSideStreamingServer) Send(m *HelloResponse) error {
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SatHelloServerSideStreaming",
			Handler:       _GreetService_SatHelloServerSideStreaming_Handler,
			ServerStreams: true,
		},
		{
